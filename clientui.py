...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.self.setGeometry(QtCore.QRect(980, 80, 431, 651))
        ...
        self.connect_button = PrimaryPushButton(self.centralwidget)
        self.connect_button.setGeometry(QtCore.QRect(650, 240, 153, 32))
